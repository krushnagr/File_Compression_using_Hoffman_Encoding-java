...
public class HuffCompression {
    ...
    private static byte[] createZip(byte[] bytes) {
        ...
        for(int i=0;i<huffmanCodeBytes.length;i++){
            System.out.println(huffmanCodeBytes[i]);
        }
    ...
    public static void main(String[] args) {
        compress("C:\\Users\\91762\\Desktop\\text.txt","C:\\Users\\91762\\Desktop\\text1.txt");
        decompress("C:\\Users\\91762\\Desktop\\text1.txt","C:\\Users\\91762\\Desktop\\text10.txt");
    }
}
